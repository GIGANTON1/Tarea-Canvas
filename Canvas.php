...
class Canvas implements \Ratchet\MessageComponentInterface
{
    ...
    function onOpen(\Ratchet\ConnectionInterface $conn)
    {
        ...
        /*$dibujo = json_decode($conn, true);
        $llamado = $this->conexion->prepare('SELECT (coord_x, coord_y, color, grosor) FROM coordenadas');
        foreach ($dibujo as $dato){
            print_r($llamado, $dato);
        }*/
    }
